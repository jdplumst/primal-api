...
namespace server.Migrations
{
    ...
    [Migration("20230818202248_AddForeignKeysToSizeAndWeight")]
    partial class AddForeignKeysToSizeAndWeight
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.Pokemon", b =>
                {
                    b.HasOne("server.Models.Size", null)
                        .WithMany("Pokemon")
                        .HasForeignKey("SizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("server.Models.Weight", null)
                        .WithMany("Pokemon")
