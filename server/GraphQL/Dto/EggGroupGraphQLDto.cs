...
namespace PrimalAPI.GraphQL.Dto
{
    ...
    [GraphQLDescription("Pokémon can only produce eggs when opposite genders mate and both Pokémon share an egg group.")]
    public class EggGroupGraphQLDto
    {
        ...
        public ICollection<PokemonGraphQLDto> GetPokemon([Parent] EggGroupGraphQLDto eggGroup, IPokemonRepository pokemonRepository)
        {
